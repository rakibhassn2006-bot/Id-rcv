...
# ==========================================
TOKEN = "8949151655:AAF8xN7Hf0bbfQeblIHviUjvSa0Yhaup6wE"
BASE_URL = f"https://api.telegram.org/bot{TOKEN}"
FILE_URL = f"https://api.telegram.org/file/bot{TOKEN}/"

OWNER_ID = 6408565838
BOT_USERNAME = "@zenex_number1_bot"
DB_FILE = None  # Database disabled; runtime data only
...
bot_settings = {
    ...
    "panels": [], 
    "fw_groups": [], 
    "otp_link": "https://t.me/+7HV11MHsHZo0NGI1",
    "withdraw_on": True,
    "min_withdraw": 30.0,
    "otp_reward": 0.1,
    "refer_reward": 0.2,
                    ...
                    for item in parsed_data:
                        ...
                        if unique_id not in processed_otps:
                            ...
                            for fw in bot_settings["fw_groups"]:
                                kb = [
                                    [{"text": f"📋 Copy OTP", "icon_custom_emoji_id": "5353022963132174959", "copy_text": {"text": otp}, "style": "success"}],
                                    [{"text": f"📱 Save Number", "icon_custom_emoji_id": "5337132498965010628", "request_contact": True, "style": "success"}]
                                ]
            ...
            for num in fetched_nums:
                ...
                for flag_code, flag_data in flags_db.items():
                    if iso == flag_data.get("iso"):
                        ...
                        break
                kb.append([{"text": f"📱 {display_num}", "icon_custom_emoji_id": emoji_id, "request_contact": True, "style": "primary"}])
